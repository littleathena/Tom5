        ...
        this.execute = async ({ ctx }) => {
            ...
            switch(subCommand) {
                case "parcerias": {
                    ...
                    if(pingRole) {
                        let role = ctx.interaction?.guild?.roles.cache.get(pingRole)
                    ...
                    msg.createMessageComponentCollector(
                        ...
                        switch(id) {
                            case "config_channel_partners": {
                                ...
                                const iinteraction = await i.reply(
                                    {
                                ...
                                i.channel?.createMessageCollector(
                                    ...
                                    if(!channel) channel = await ctx.interaction?.guild?.channels.fetch(i1.content)
                            ...
                            case "config_cargo_partners": {
                                ...
                                i.channel?.createMessageCollector(
                                    ...
                                    if(!role) role = ctx.interaction?.guild?.roles.cache.get(i1.content)
